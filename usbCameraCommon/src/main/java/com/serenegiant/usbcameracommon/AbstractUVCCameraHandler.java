...
public abstract class AbstractUVCCameraHandler extends Handler {
    ...
    private static Set<OnPreviewResultListener> mPreviewListeners = new CopyOnWriteArraySet<>();
    ...
    static final class CameraThread extends Thread {
        ...
        //alextao modified here for test using the functions.
            ...
            try {
                ...
                switch (mEncoderType) {
                    case 1:    // for video capturing using MediaVideoEncoder
                        mediaVideoEncoder = new MediaVideoEncoder(muxer, getWidth(), getHeight(), mMediaEncoderListener);
                        break;
        ...
        private final IFrameCallback mIFrameCallback = new IFrameCallback() {
            ...
            public void onFrame(final ByteBuffer frame) {
                ...
                for (OnPreviewResultListener listener : mPreviewListeners) {
                    listener.onPreviewResult(yuv);
                }
        ...
        public void handleUpdateMedia(final String path) {
            ...
            if (parent != null && parent.getApplicationContext() != null) {
                ...
                if (released || parent.isDestroyed()) handleRelease();
            } else {
        ...
        private final MediaEncoder.MediaEncoderListener mMediaEncoderListener = new MediaEncoder.MediaEncoderListener() {
            ...
            public void onPrepared(final MediaEncoder encoder) {
                ...
                mIsRecording = true;
                if (encoder instanceof MediaVideoEncoder) try {
                    mWeakCameraView.get().setVideoEncoder((MediaVideoEncoder) encoder);
                } catch (final Exception e) {
                    Log.e(TAG, "onPrepared:", e);
                }
                if (encoder instanceof MediaSurfaceEncoder) try {
